...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1521, 796)
        self.centralwidget = QtGui.QWidget(MainWindow)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.graphicsView = QtGui.QGraphicsView(self.centralwidget)
        self.graphicsView.setGeometry(QtCore.QRect(10, 50, 661, 661))
        ...
        self.tableWidget.setGeometry(QtCore.QRect(680, 50, 251, 551))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.textBrowser.setGeometry(QtCore.QRect(680, 610, 251, 101))
        self.textBrowser.setObjectName(_fromUtf8("textBrowser"))
        self.tableDataFiles = QtGui.QTableWidget(self.centralwidget)
        self.tableDataFiles.setGeometry(QtCore.QRect(940, 50, 571, 291))
        self.tableDataFiles.setEditTriggers(QtGui.QAbstractItemView.NoEditTriggers)
        self.tableDataFiles.setSelectionMode(QtGui.QAbstractItemView.NoSelection)
        self.tableDataFiles.setCornerButtonEnabled(False)
        self.tableDataFiles.setObjectName(_fromUtf8("tableDataFiles"))
        self.tableDataFiles.setColumnCount(17)
        self.tableDataFiles.setRowCount(0)
        item = QtGui.QTableWidgetItem()
        self.tableDataFiles.setHorizontalHeaderItem(0, item)
        item = QtGui.QTableWidgetItem()
        self.tableDataFiles.setHorizontalHeaderItem(1, item)
        item = QtGui.QTableWidgetItem()
        self.tableDataFiles.setHorizontalHeaderItem(2, item)
        item = QtGui.QTableWidgetItem()
        self.tableDataFiles.setHorizontalHeaderItem(3, item)
        item = QtGui.QTableWidgetItem()
        self.tableDataFiles.setHorizontalHeaderItem(4, item)
        item = QtGui.QTableWidgetItem()
        self.tableDataFiles.setHorizontalHeaderItem(5, item)
        item = QtGui.QTableWidgetItem()
        self.tableDataFiles.setHorizontalHeaderItem(6, item)
        item = QtGui.QTableWidgetItem()
        self.tableDataFiles.setHorizontalHeaderItem(7, item)
        item = QtGui.QTableWidgetItem()
        self.tableDataFiles.setHorizontalHeaderItem(8, item)
        item = QtGui.QTableWidgetItem()
        self.tableDataFiles.setHorizontalHeaderItem(9, item)
        item = QtGui.QTableWidgetItem()
        self.tableDataFiles.setHorizontalHeaderItem(10, item)
        item = QtGui.QTableWidgetItem()
        self.tableDataFiles.setHorizontalHeaderItem(11, item)
        item = QtGui.QTableWidgetItem()
        self.tableDataFiles.setHorizontalHeaderItem(12, item)
        item = QtGui.QTableWidgetItem()
        self.tableDataFiles.setHorizontalHeaderItem(13, item)
        item = QtGui.QTableWidgetItem()
        self.tableDataFiles.setHorizontalHeaderItem(14, item)
        item = QtGui.QTableWidgetItem()
        self.tableDataFiles.setHorizontalHeaderItem(15, item)
        item = QtGui.QTableWidgetItem()
        self.tableDataFiles.setHorizontalHeaderItem(16, item)
        self.tableDataFiles.horizontalHeader().setDefaultSectionSize(30)
        self.tableDataFiles.verticalHeader().setVisible(False)
        self.tableCounters = QtGui.QTableWidget(self.centralwidget)
        self.tableCounters.setGeometry(QtCore.QRect(1230, 350, 281, 361))
        self.tableCounters.setObjectName(_fromUtf8("tableCounters"))
        self.tableCounters.setColumnCount(9)
        self.tableCounters.setRowCount(0)
        item = QtGui.QTableWidgetItem()
        self.tableCounters.setHorizontalHeaderItem(0, item)
        item = QtGui.QTableWidgetItem()
        self.tableCounters.setHorizontalHeaderItem(1, item)
        item = QtGui.QTableWidgetItem()
        self.tableCounters.setHorizontalHeaderItem(2, item)
        item = QtGui.QTableWidgetItem()
        self.tableCounters.setHorizontalHeaderItem(3, item)
        item = QtGui.QTableWidgetItem()
        self.tableCounters.setHorizontalHeaderItem(4, item)
        item = QtGui.QTableWidgetItem()
        self.tableCounters.setHorizontalHeaderItem(5, item)
        item = QtGui.QTableWidgetItem()
        self.tableCounters.setHorizontalHeaderItem(6, item)
        item = QtGui.QTableWidgetItem()
        self.tableCounters.setHorizontalHeaderItem(7, item)
        item = QtGui.QTableWidgetItem()
        self.tableCounters.setHorizontalHeaderItem(8, item)
        self.tableCounters.horizontalHeader().setDefaultSectionSize(30)
        self.tableTimers = QtGui.QTableWidget(self.centralwidget)
        self.tableTimers.setGeometry(QtCore.QRect(940, 350, 281, 361))
        self.tableTimers.setObjectName(_fromUtf8("tableTimers"))
        self.tableTimers.setColumnCount(7)
        self.tableTimers.setRowCount(0)
        item = QtGui.QTableWidgetItem()
        self.tableTimers.setHorizontalHeaderItem(0, item)
        item = QtGui.QTableWidgetItem()
        self.tableTimers.setHorizontalHeaderItem(1, item)
        item = QtGui.QTableWidgetItem()
        self.tableTimers.setHorizontalHeaderItem(2, item)
        item = QtGui.QTableWidgetItem()
        self.tableTimers.setHorizontalHeaderItem(3, item)
        item = QtGui.QTableWidgetItem()
        self.tableTimers.setHorizontalHeaderItem(4, item)
        item = QtGui.QTableWidgetItem()
        self.tableTimers.setHorizontalHeaderItem(5, item)
        item = QtGui.QTableWidgetItem()
        self.tableTimers.setHorizontalHeaderItem(6, item)
        self.tableTimers.horizontalHeader().setDefaultSectionSize(39)
        self.liveButton = QtGui.QPushButton(self.centralwidget)
        self.liveButton.setGeometry(QtCore.QRect(310, 10, 75, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tableDataFiles.setSortingEnabled(True)
        item = self.tableDataFiles.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Offset", None))
        item = self.tableDataFiles.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "15", None))
        item = self.tableDataFiles.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "14", None))
        item = self.tableDataFiles.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "13", None))
        item = self.tableDataFiles.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "12", None))
        item = self.tableDataFiles.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "11", None))
        item = self.tableDataFiles.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "10", None))
        item = self.tableDataFiles.horizontalHeaderItem(7)
        item.setText(_translate("MainWindow", "9", None))
        item = self.tableDataFiles.horizontalHeaderItem(8)
        item.setText(_translate("MainWindow", "8", None))
        item = self.tableDataFiles.horizontalHeaderItem(9)
        item.setText(_translate("MainWindow", "7", None))
        item = self.tableDataFiles.horizontalHeaderItem(10)
        item.setText(_translate("MainWindow", "6", None))
        item = self.tableDataFiles.horizontalHeaderItem(11)
        item.setText(_translate("MainWindow", "5", None))
        item = self.tableDataFiles.horizontalHeaderItem(12)
        item.setText(_translate("MainWindow", "4", None))
        item = self.tableDataFiles.horizontalHeaderItem(13)
        item.setText(_translate("MainWindow", "3", None))
        item = self.tableDataFiles.horizontalHeaderItem(14)
        item.setText(_translate("MainWindow", "2", None))
        item = self.tableDataFiles.horizontalHeaderItem(15)
        item.setText(_translate("MainWindow", "1", None))
        item = self.tableDataFiles.horizontalHeaderItem(16)
        item.setText(_translate("MainWindow", "0", None))
        item = self.tableCounters.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Offset", None))
        item = self.tableCounters.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "CU", None))
        item = self.tableCounters.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "CD", None))
        item = self.tableCounters.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "DN", None))
        item = self.tableCounters.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "OV", None))
        item = self.tableCounters.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "UN", None))
        item = self.tableCounters.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "UA", None))
        item = self.tableCounters.horizontalHeaderItem(7)
        item.setText(_translate("MainWindow", "PRE", None))
        item = self.tableCounters.horizontalHeaderItem(8)
        item.setText(_translate("MainWindow", "ACC", None))
        item = self.tableTimers.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Offset", None))
        item = self.tableTimers.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "EN", None))
        item = self.tableTimers.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "TT", None))
        item = self.tableTimers.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "DN", None))
        item = self.tableTimers.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Base", None))
        item = self.tableTimers.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "PRE", None))
        item = self.tableTimers.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "ACC", None))
