...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.undoBbutton, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.liveButton, 0, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.graphicsView, 2, 0, 2, 7)
...
##
        ...
        self.waltechHW.setAcceptDrops(True)
        self.scene = QtGui.QGraphicsScene(self.waltechHW)
        self.p = self.scene.addPixmap(QtGui.QPixmap("Waltech.png"))
        self.waltechHW.setScene(self.scene)
        self.waltechHW.setMouseTracking(True)  
        self.waltechHW.setObjectName(_fromUtf8("waltechHW"))
        button = Button(self.waltechF)
        button.move(100,65)
        self.stackedWidget.addWidget(self.waltechF)
        #UNO
        self.unoF = QtGui.QWidget(self.stackedWidget)
        self.unoHW = QtGui.QGraphicsView(self.unoF)
        self.uno_scene = QtGui.QGraphicsScene(self.unoHW)
        self.p = self.uno_scene.addPixmap(QtGui.QPixmap("Arduino_Uno.png"))	
        self.unoHW.setScene(self.uno_scene)
        self.unoHW.setMouseTracking(True)  
        self.unoHW.setObjectName(_fromUtf8("unoHW"))
        #Uno Input Buttons
        self.uno_in1 = Button(self.unoF)
        self.uno_in1.setText("in_1")
        self.uno_in1.setStyleSheet("background-color: blue; color: white")
        self.uno_in1.setGeometry(QtCore.QRect(10, 445, 80, 18))
        self.uno_in1.setObjectName(_fromUtf8("uno_in_1"))
        self.uno_in2 = Button(self.unoF)
        self.uno_in2.setText("in_2")
        self.uno_in2.setStyleSheet("background-color: blue; color: white")
        self.uno_in2.setGeometry(QtCore.QRect(10, 465, 80, 18))
        self.uno_in2.setObjectName(_fromUtf8("uno_in2"))
        self.uno_in3 = Button(self.unoF)
        self.uno_in3.setText("in_3")
        self.uno_in3.setStyleSheet("background-color: blue; color: white")
        self.uno_in3.setGeometry(QtCore.QRect(300, 430, 80, 18))
        self.uno_in3.setObjectName(_fromUtf8("uno_in3"))
        self.uno_in4 = Button(self.unoF)
        self.uno_in4.setText("in_4")
        self.uno_in4.setStyleSheet("background-color: blue; color: white")
        self.uno_in4.setGeometry(QtCore.QRect(300, 413, 80, 18))
        self.uno_in4.setObjectName(_fromUtf8("uno_in4"))
        self.uno_in5 = Button(self.unoF)
        self.uno_in5.setText("in_5")
        self.uno_in5.setStyleSheet("background-color: blue; color: white")
        self.uno_in5.setGeometry(QtCore.QRect(300, 396, 80, 18))
        self.uno_in5.setObjectName(_fromUtf8("uno_in5"))
        #Uno Output Buttons
        self.uno_out1 = Button(self.unoF)
        self.uno_out1.setText("out_1")
        self.uno_out1.setStyleSheet("background-color: red; color: white")
        self.uno_out1.setGeometry(QtCore.QRect(300, 378, 80, 18))
        self.uno_out1.setObjectName(_fromUtf8("uno_out1"))
        self.uno_out2 = Button(self.unoF)
        self.uno_out2.setText("out_2")
        self.uno_out2.setStyleSheet("background-color: red; color: white")
        self.uno_out2.setGeometry(QtCore.QRect(300, 361, 80, 18))
        self.uno_out2.setObjectName(_fromUtf8("uno_out2"))
        self.uno_out3 = Button(self.unoF)
        self.uno_out3.setText("out_3")
        self.uno_out3.setStyleSheet("background-color: red; color: white")
        self.uno_out3.setGeometry(QtCore.QRect(300, 344, 80, 18))
        self.uno_out3.setObjectName(_fromUtf8("uno_out3"))
        self.uno_out4 = Button(self.unoF)
        self.uno_out4.setText("out_4")
        self.uno_out4.setStyleSheet("background-color: red; color: white")
        self.uno_out4.setGeometry(QtCore.QRect(300, 320, 80, 18))
        self.uno_out4.setObjectName(_fromUtf8("uno_out4"))
        self.uno_out5 = Button(self.unoF)
        self.uno_out5.setText("out_5")
        self.uno_out5.setStyleSheet("background-color: red; color: white")
        self.uno_out5.setGeometry(QtCore.QRect(300, 272, 80, 18))
        self.uno_out5.setObjectName(_fromUtf8("uno_out5"))
        self.uno_out6 = Button(self.unoF)
        self.uno_out6.setText("out_6")
        self.uno_out6.setStyleSheet("background-color: red; color: white")
        self.uno_out6.setGeometry(QtCore.QRect(300, 255, 80, 18))
        self.uno_out6.setObjectName(_fromUtf8("uno_out6"))
        self.uno_out7 = Button(self.unoF)
        self.uno_out7.setText("out_7")
        self.uno_out7.setStyleSheet("background-color: red; color: white")
        self.uno_out7.setGeometry(QtCore.QRect(300, 238, 80, 18))
        self.uno_out7.setObjectName(_fromUtf8("uno_out7"))
        self.stackedWidget.addWidget(self.unoF)
		
        #MEGA
        self.megaF = QtGui.QWidget(self.stackedWidget)
        self.megaHW = QtGui.QGraphicsView(self.megaF)
        self.mega_scene = QtGui.QGraphicsScene(self.megaHW)
        self.p = self.mega_scene.addPixmap(QtGui.QPixmap("Arduino_Mega.png"))	
        self.megaHW.setScene(self.mega_scene)
        self.megaHW.setMouseTracking(True)
        self.megaHW.setObjectName(_fromUtf8("megaHW"))
        #Mega Input Buttons
        self.mega_in1 = Button(self.megaF)
        self.mega_in1.setText("in_1")
        self.mega_in1.setStyleSheet("background-color: blue; color: white")
        self.mega_in1.setGeometry(QtCore.QRect(5, 280, 65, 18))
        self.mega_in1.setObjectName(_fromUtf8("mega_in1"))
        self.mega_in2 = Button(self.megaF)
        self.mega_in2.setText("in_2")
        self.mega_in2.setStyleSheet("background-color: blue; color: white")
        self.mega_in2.setGeometry(QtCore.QRect(5, 300, 65, 18))
        self.mega_in2.setObjectName(_fromUtf8("mega_in2"))
        self.mega_in3 = Button(self.megaF)
        self.mega_in3.setText("in_3")
        self.mega_in3.setStyleSheet("background-color: blue; color: white")
        self.mega_in3.setGeometry(QtCore.QRect(5, 320, 65, 18))
        self.mega_in3.setObjectName(_fromUtf8("mega_in3"))
        self.mega_in4 = Button(self.megaF)
        self.mega_in4.setText("in_4")
        self.mega_in4.setStyleSheet("background-color: blue; color: white")
        self.mega_in4.setGeometry(QtCore.QRect(5, 340, 65, 18))
        self.mega_in4.setObjectName(_fromUtf8("mega_in4"))
        self.mega_in5 = Button(self.megaF)
        self.mega_in5.setText("in_5")
        self.mega_in5.setStyleSheet("background-color: blue; color: white")
        self.mega_in5.setGeometry(QtCore.QRect(5, 360, 65, 18))
        self.mega_in5.setObjectName(_fromUtf8("mega_in5"))
        self.mega_in6 = Button(self.megaF)
        self.mega_in6.setText("in_6")
        self.mega_in6.setStyleSheet("background-color: blue; color: white")
        self.mega_in6.setGeometry(QtCore.QRect(5, 380, 65, 18))
        self.mega_in6.setObjectName(_fromUtf8("mega_in6"))
        self.mega_in7 = Button(self.megaF)
        self.mega_in7.setText("in_7")
        self.mega_in7.setStyleSheet("background-color: blue; color: white")
        self.mega_in7.setGeometry(QtCore.QRect(5, 400, 65, 18))
        self.mega_in7.setObjectName(_fromUtf8("mega_in7"))
        self.mega_in8 = Button(self.megaF)
        self.mega_in8.setText("in_8")
        self.mega_in8.setStyleSheet("background-color: blue; color: white")
        self.mega_in8.setGeometry(QtCore.QRect(5, 420, 65, 18))
        self.mega_in8.setObjectName(_fromUtf8("mega_in8"))
        self.mega_in9 = Button(self.megaF)
        self.mega_in9.setText("9")
        self.mega_in9.setStyleSheet("background-color: blue; color: white")
        self.mega_in9.setGeometry(QtCore.QRect(75, 450, 15, 60))
        self.mega_in9.setObjectName(_fromUtf8("mega_in9"))
        self.mega_in10 = Button(self.megaF)
        self.mega_in10.setText("10")
        self.mega_in10.setStyleSheet("background-color: blue; color: white")
        self.mega_in10.setGeometry(QtCore.QRect(92, 450, 15, 60))
        self.mega_in10.setObjectName(_fromUtf8("mega_in10"))
        self.mega_in11 = Button(self.megaF)
        self.mega_in11.setText("11")
        self.mega_in11.setStyleSheet("background-color: blue; color: white")
        self.mega_in11.setGeometry(QtCore.QRect(109, 450, 15, 60))
        self.mega_in11.setObjectName(_fromUtf8("mega_in11"))
        self.mega_in12 = Button(self.megaF)
        self.mega_in12.setText("12")
        self.mega_in12.setStyleSheet("background-color: blue; color: white")
        self.mega_in12.setGeometry(QtCore.QRect(126, 450, 15, 60))
        self.mega_in12.setObjectName(_fromUtf8("mega_in12"))
        self.mega_in13 = Button(self.megaF)
        self.mega_in13.setText("13")
        self.mega_in13.setStyleSheet("background-color: blue; color: white")
        self.mega_in13.setGeometry(QtCore.QRect(143, 450, 15, 60))
        self.mega_in13.setObjectName(_fromUtf8("mega_in13"))
        self.mega_in14 = Button(self.megaF)
        self.mega_in14.setText("14")
        self.mega_in14.setStyleSheet("background-color: blue; color: white")
        self.mega_in14.setGeometry(QtCore.QRect(160, 450, 15, 60))
        self.mega_in14.setObjectName(_fromUtf8("mega_in14"))
        self.mega_in15 = Button(self.megaF)
        self.mega_in15.setText("15")
        self.mega_in15.setStyleSheet("background-color: blue; color: white")
        self.mega_in15.setGeometry(QtCore.QRect(177, 450, 15, 60))
        self.mega_in15.setObjectName(_fromUtf8("mega_in15"))
        self.mega_in16 = Button(self.megaF)
        self.mega_in16.setText("16")
        self.mega_in16.setStyleSheet("background-color: blue; color: white")
        self.mega_in16.setGeometry(QtCore.QRect(194, 450, 15, 60))
        self.mega_in16.setObjectName(_fromUtf8("mega_in16"))
        self.mega_in17 = Button(self.megaF)
        self.mega_in17.setText("17")
        self.mega_in17.setStyleSheet("background-color: blue; color: white")
        self.mega_in17.setGeometry(QtCore.QRect(211, 450, 15, 60))
        self.mega_in17.setObjectName(_fromUtf8("mega_in17"))
        self.mega_in18 = Button(self.megaF)
        self.mega_in18.setText("18")
        self.mega_in18.setStyleSheet("background-color: blue; color: white")
        self.mega_in18.setGeometry(QtCore.QRect(228, 450, 15, 60))
        self.mega_in18.setObjectName(_fromUtf8("mega_in18"))
        self.mega_in19 = Button(self.megaF)
        self.mega_in19.setText("19")
        self.mega_in19.setStyleSheet("background-color: blue; color: white")
        self.mega_in19.setGeometry(QtCore.QRect(245, 450, 15, 60))
        self.mega_in19.setObjectName(_fromUtf8("mega_in19"))
        self.mega_in20 = Button(self.megaF)
        self.mega_in20.setText("20")
        self.mega_in20.setStyleSheet("background-color: blue; color: white")
        self.mega_in20.setGeometry(QtCore.QRect(262, 450, 15, 60))
        self.mega_in20.setObjectName(_fromUtf8("mega_in20"))
        self.mega_in21 = Button(self.megaF)
        self.mega_in21.setText("in_21")
        self.mega_in21.setStyleSheet("background-color: blue; color: white")
        self.mega_in21.setGeometry(QtCore.QRect(300, 380, 65, 18))
        self.mega_in21.setObjectName(_fromUtf8("mega_in21"))
        self.mega_in22 = Button(self.megaF)
        self.mega_in22.setText("in_22")
        self.mega_in22.setStyleSheet("background-color: blue; color: white")
        self.mega_in22.setGeometry(QtCore.QRect(300, 360, 65, 18))
        self.mega_in22.setObjectName(_fromUtf8("mega_in22"))
        #Mega Output Buttons
        self.mega_out = Button(self.megaF)
        self.mega_out.setText("1")
        self.mega_out.setStyleSheet("background-color: red; color: white")
        self.mega_out.setGeometry(QtCore.QRect(75, 385, 15, 60))
        self.mega_out.setObjectName(_fromUtf8("mega_out1"))
        self.mega_out2 = Button(self.megaF)
        self.mega_out2.setText("2")
        self.mega_out2.setStyleSheet("background-color: red; color: white")
        self.mega_out2.setGeometry(QtCore.QRect(92, 385, 15, 60))
        self.mega_out2.setObjectName(_fromUtf8("mega_out2"))
        self.mega_out3 = Button(self.megaF)
        self.mega_out3.setText("3")
        self.mega_out3.setStyleSheet("background-color: red; color: white")
        self.mega_out3.setGeometry(QtCore.QRect(108, 385, 15, 60))
        self.mega_out3.setObjectName(_fromUtf8("mega_out3"))
        self.mega_out4 = Button(self.megaF)
        self.mega_out4.setText("4")
        self.mega_out4.setStyleSheet("background-color: red; color: white")
        self.mega_out4.setGeometry(QtCore.QRect(124, 385, 15, 60))
        self.mega_out4.setObjectName(_fromUtf8("mega_out4"))
        self.mega_out5 = Button(self.megaF)
        self.mega_out5.setText("5")
        self.mega_out5.setStyleSheet("background-color: red; color: white")
        self.mega_out5.setGeometry(QtCore.QRect(140, 385, 15, 60))
        self.mega_out5.setObjectName(_fromUtf8("mega_out5"))
        self.mega_out6 = Button(self.megaF)
        self.mega_out6.setText("6")
        self.mega_out6.setStyleSheet("background-color: red; color: white")
        self.mega_out6.setGeometry(QtCore.QRect(156, 385, 15, 60))
        self.mega_out6.setObjectName(_fromUtf8("mega_out6"))
        self.mega_out7 = Button(self.megaF)
        self.mega_out7.setText("7")
        self.mega_out7.setStyleSheet("background-color: red; color: white")
        self.mega_out7.setGeometry(QtCore.QRect(172, 385, 15, 60))
        self.mega_out7.setObjectName(_fromUtf8("mega_out7"))
        self.mega_out8 = Button(self.megaF)
        self.mega_out8.setText("8")
        self.mega_out8.setStyleSheet("background-color: red; color: white")
        self.mega_out8.setGeometry(QtCore.QRect(188, 385, 15, 60))
        self.mega_out8.setObjectName(_fromUtf8("mega_out8"))
        self.mega_out9 = Button(self.megaF)
        self.mega_out9.setText("9")
        self.mega_out9.setStyleSheet("background-color: red; color: white")
        self.mega_out9.setGeometry(QtCore.QRect(204, 385, 15, 60))
        self.mega_out9.setObjectName(_fromUtf8("mega_out9"))
        self.mega_out10 = Button(self.megaF)
        self.mega_out10.setText("10")
        self.mega_out10.setStyleSheet("background-color: red; color: white")
        self.mega_out10.setGeometry(QtCore.QRect(220, 385, 15, 60))
        self.mega_out10.setObjectName(_fromUtf8("mega_out10"))
        self.mega_out11 = Button(self.megaF)
        self.mega_out11.setText("11")
        self.mega_out11.setStyleSheet("background-color: red; color: white")
        self.mega_out11.setGeometry(QtCore.QRect(236, 385, 15, 60))
        self.mega_out11.setObjectName(_fromUtf8("mega_out11"))
        self.mega_out12 = Button(self.megaF)
        self.mega_out12.setText("12")
        self.mega_out12.setStyleSheet("background-color: red; color: white")
        self.mega_out12.setGeometry(QtCore.QRect(252, 385, 15, 60))
        self.mega_out12.setObjectName(_fromUtf8("mega_out12"))
        self.mega_out13 = Button(self.megaF)
        self.mega_out13.setText("13")
        self.mega_out13.setStyleSheet("background-color: red; color: white")
        self.mega_out13.setGeometry(QtCore.QRect(268, 385, 15, 60))
        self.mega_out13.setObjectName(_fromUtf8("mega_out13"))
        self.mega_out14 = Button(self.megaF)
        self.mega_out14.setText("14")
        self.mega_out14.setStyleSheet("background-color: red; color: white")
        self.mega_out14.setGeometry(QtCore.QRect(284, 400, 15, 50))
        self.mega_out14.setObjectName(_fromUtf8("mega_out14"))
        self.mega_out15 = Button(self.megaF)
        self.mega_out15.setText("15")
        self.mega_out15.setStyleSheet("background-color: red; color: white")
        self.mega_out15.setGeometry(QtCore.QRect(300, 400, 15, 50))
        self.mega_out15.setObjectName(_fromUtf8("mega_out15"))
        self.mega_out16 = Button(self.megaF)
        self.mega_out16.setText("16")
        self.mega_out16.setStyleSheet("background-color: red; color: white")
        self.mega_out16.setGeometry(QtCore.QRect(316, 400, 15, 50))
        self.mega_out16.setObjectName(_fromUtf8("mega_out16"))
        self.mega_out17 = Button(self.megaF)
        self.mega_out17.setText("out_17")
        self.mega_out17.setStyleSheet("background-color: red; color: white")
        self.mega_out17.setGeometry(QtCore.QRect(300, 340, 65, 18))
        self.mega_out17.setObjectName(_fromUtf8("mega_out17"))
        self.mega_out18 = Button(self.megaF)
        self.mega_out18.setText("out_18")
        self.mega_out18.setStyleSheet("background-color: red; color: white")
        self.mega_out18.setGeometry(QtCore.QRect(300, 320, 65, 18))
        self.mega_out18.setObjectName(_fromUtf8("mega_out18"))
        self.mega_out19 = Button(self.megaF)
        self.mega_out19.setText("out_19")
        self.mega_out19.setStyleSheet("background-color: red; color: white")
        self.mega_out19.setGeometry(QtCore.QRect(300, 300, 65, 18))
        self.mega_out19.setObjectName(_fromUtf8("mega_out19"))
        self.mega_out20 = Button(self.megaF)
        self.mega_out20.setText("out_20")
        self.mega_out20.setStyleSheet("background-color: red; color: white")
        self.mega_out20.setGeometry(QtCore.QRect(300, 280, 65, 18))
        self.mega_out20.setObjectName(_fromUtf8("mega_out20"))
        self.mega_out21 = Button(self.megaF)
        self.mega_out21.setText("out_21")
        self.mega_out21.setStyleSheet("background-color: red; color: white")
        self.mega_out21.setGeometry(QtCore.QRect(300, 260, 65, 18))
        self.mega_out21.setObjectName(_fromUtf8("mega_out21"))
        self.mega_out22 = Button(self.megaF)
        self.mega_out22.setText("out_22")
        self.mega_out22.setStyleSheet("background-color: red; color: white")
        self.mega_out22.setGeometry(QtCore.QRect(300, 240, 65, 18))
        self.mega_out22.setObjectName(_fromUtf8("mega_out22"))
        self.stackedWidget.addWidget(self.megaF)
		
        #NANO	
        self.nanoF = QtGui.QWidget(self.stackedWidget)
        self.nanoHW = QtGui.QGraphicsView(self.nanoF)
        self.nano_scene = QtGui.QGraphicsScene(self.nanoHW)
        self.p = self.nano_scene.addPixmap(QtGui.QPixmap("Arduino_Nano.png"))	
        self.nanoHW.setScene(self.nano_scene)
        self.nanoHW.setMouseTracking(True)
        self.nanoHW.setObjectName(_fromUtf8("nanoHW"))
        #Nano Input Buttons
        self.nano_in1 = Button(self.nanoF)
        self.nano_in1.setText("in_1")
        self.nano_in1.setStyleSheet("background-color: blue; color: white")
        self.nano_in1.setGeometry(QtCore.QRect(5, 258, 110, 25))
        self.nano_in1.setObjectName(_fromUtf8("nano_in1"))
        self.nano_in2 = Button(self.nanoF)
        self.nano_in2.setText("in_2")
        self.nano_in2.setStyleSheet("background-color: blue; color: white")
        self.nano_in2.setGeometry(QtCore.QRect(5, 285, 110, 25))
        self.nano_in2.setObjectName(_fromUtf8("nano_in2"))
        self.nano_in3 = Button(self.nanoF)
        self.nano_in3.setText("in_3")
        self.nano_in3.setStyleSheet("background-color: blue; color: white")
        self.nano_in3.setGeometry(QtCore.QRect(260, 342, 110, 25))
        self.nano_in3.setObjectName(_fromUtf8("nano_in3"))
        self.nano_in4 = Button(self.nanoF)
        self.nano_in4.setText("in_4")
        self.nano_in4.setStyleSheet("background-color: blue; color: white")
        self.nano_in4.setGeometry(QtCore.QRect(260, 315, 110, 25))
        self.nano_in4.setObjectName(_fromUtf8("nano_in4"))
        self.nano_in5 = Button(self.nanoF)
        self.nano_in5.setText("in_5")
        self.nano_in5.setStyleSheet("background-color: blue; color: white")
        self.nano_in5.setGeometry(QtCore.QRect(260, 288, 110, 25))
        self.nano_in5.setObjectName(_fromUtf8("nano_in5"))	
        #Nano Output Buttons
        self.nano_out1 = Button(self.nanoF)
        self.nano_out1.setText("out_1")
        self.nano_out1.setStyleSheet("background-color: red; color: white")
        self.nano_out1.setGeometry(QtCore.QRect(260, 257, 110, 25))
        self.nano_out1.setObjectName(_fromUtf8("nano_out1"))
        self.nano_out2 = Button(self.nanoF)
        self.nano_out2.setText("out_2")
        self.nano_out2.setStyleSheet("background-color: red; color: white")
        self.nano_out2.setGeometry(QtCore.QRect(260, 228, 110, 25))
        self.nano_out2.setObjectName(_fromUtf8("nano_out2"))
        self.nano_out3 = Button(self.nanoF)
        self.nano_out3.setText("out_3")
        self.nano_out3.setStyleSheet("background-color: red; color: white")
        self.nano_out3.setGeometry(QtCore.QRect(260, 198, 110, 25))
        self.nano_out3.setObjectName(_fromUtf8("nano_out3"))
        self.nano_out4 = Button(self.nanoF)
        self.nano_out4.setText("out_4")
        self.nano_out4.setStyleSheet("background-color: red; color: white")
        self.nano_out4.setGeometry(QtCore.QRect(260, 170, 110, 25))
        self.nano_out4.setObjectName(_fromUtf8("nano_out4"))
        self.nano_out5 = Button(self.nanoF)
        self.nano_out5.setText("out_5")
        self.nano_out5.setStyleSheet("background-color: red; color: white")
        self.nano_out5.setGeometry(QtCore.QRect(260, 84, 110, 25))
        self.nano_out5.setObjectName(_fromUtf8("nano_out5"))
        self.nano_out6 = Button(self.nanoF)
        self.nano_out6.setText("out_6")
        self.nano_out6.setStyleSheet("background-color: red; color: white")
        self.nano_out6.setGeometry(QtCore.QRect(260, 55, 110, 25))
        self.nano_out6.setObjectName(_fromUtf8("nano_out6"))
        self.nano_out7 = Button(self.nanoF)
        self.nano_out7.setText("out_7")
        self.nano_out7.setStyleSheet("background-color: red; color: white")
...
#######################################################################################################	
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.liveButton.setText(_translate("MainWindow", "Go Live", None))
