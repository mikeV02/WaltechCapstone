...
#endif
#ifdef GENERATOR_FILE
extern int avr_mcu_index;
#else
  int x_avr_mcu_index;
#define avr_mcu_index global_options.x_avr_mcu_index
#endif
#ifdef GENERATOR_FILE
extern int avr_sp8;
#else
...
#define MASK_INT8 (1 << 3)
#define MASK_NO_INTERRUPTS (1 << 4)
#define MASK_ORDER_1 (1 << 5)
#define MASK_ORDER_2 (1 << 6)
#define MASK_SHORT_CALLS (1 << 7)
#define MASK_TINY_STACK (1 << 8)
...
enum opt_code
{
  ...
  OPT_maccumulate_args = 983,                /* -maccumulate-args */
  OPT_mbranch_cost_ = 984,                   /* -mbranch-cost= */
  OPT_mcall_prologues = 985,                 /* -mcall-prologues */
  OPT_mdeb = 986,                            /* -mdeb */
  OPT_mint8 = 987,                           /* -mint8 */
  OPT_mlog_ = 988,                           /* -mlog= */
  OPT_mmcu_ = 989,                           /* -mmcu= */
  OPT_mno_interrupts = 990,                  /* -mno-interrupts */
  OPT_morder1 = 991,                         /* -morder1 */
  OPT_morder2 = 992,                         /* -morder2 */
  OPT_mpmem_wrap_around = 993,               /* -mpmem-wrap-around */
  OPT_mrelax = 994,                          /* -mrelax */
  OPT_mshort_calls = 995,                    /* -mshort-calls */
  OPT_msp8 = 996,                            /* -msp8 */
  OPT_mstrict_X = 997,                       /* -mstrict-X */
  OPT_mtiny_stack = 998,                     /* -mtiny-stack */
  OPT_n = 999,                               /* -n */
